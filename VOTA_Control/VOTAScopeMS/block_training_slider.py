...
class TrainingTask(object):
    ...
    def __init__(self, water_hw, odor_gen, sound_hw, motor_hw, stat_rec, random_lq, state_lqs, reward_lqs, block = 3, delay = 2000, go = 5000, refract = 2000, punish = 5000):
        '''
