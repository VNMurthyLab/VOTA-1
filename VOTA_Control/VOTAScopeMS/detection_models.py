    ...
    def __init__(self, root_dir, transform=None):
        ...
        Args:
            ...
            transform (callable, optional): Optional transform to be applied
                on a sample.
        """
        self.label_frame = pd.read_csv(os.path.join(root_dir, 'labels.csv'))
...
def load_model(model_name, num_classes, feature_extract, device, model_path):
    '''
...
def predict(model, array, transform, device):
    '''
