...
class ArduinoWaterHW(HardwareComponent):
    ...
    def setup(self,port='COM6',baud_rate=250000):
        ...
        self.settings.New(name='open_time',initial=100,dtype=int,ro=False,vmin=1,vmax=1000)
    ...
    def connect(self):
        ...
        self.settings.water_on.connect_to_hardware(write_func=self._dev.switch)
        time.sleep(2)
