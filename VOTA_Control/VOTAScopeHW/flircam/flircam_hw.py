...
class FLIRCamHW(HardwareComponent):
    ...
    def setup(self,camera_sn = ''):
        ...
        self.settings.New(name = 'width', dtype = int, initial = 136, spinbox_step = 4, ro = False)
        self.settings.New(name = 'height', dtype = int, initial = 136, spinbox_step = 4, ro = False)
        self.settings.New(name = 'offset_x', dtype = int, initial = 292, spinbox_step = 4, ro = False)
        self.settings.New(name = 'offset_y', dtype = int, initial = 404, spinbox_step = 4, ro = False)
