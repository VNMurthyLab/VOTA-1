...
class ArduinoWaterHW(HardwareComponent):
    ...
    def setup(self,port='COM6',baud_rate=250000):
        ...
        self.settings.New(name='manual_drop_0',initial=False,dtype=bool,ro=False)
    ...
    def give_water_manual_1(self,temp=False):
    ...
    def connect(self):
        ...
        self.settings.manual_drop_0.connect_to_hardware(write_func=self.give_water_manual_0)
        self.settings.manual_drop_1.connect_to_hardware(write_func=self.give_water_manual_1)
        time.sleep(2)
